...
public class BottomSheetGovernmentHospitalChooseBindingImpl extends BottomSheetGovernmentHospitalChooseBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.timeEditText, 7);
    ...
    public BottomSheetGovernmentHospitalChooseBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }
    private BottomSheetGovernmentHospitalChooseBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.listener == variableId) {
            ...
            setViewModel((com.aligmohammad.doctorapp.ui.dialogs.governmentchoice.GovernmentHospitalChoiceViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.aligmohammad.doctorapp.ui.dialogs.governmentchoice.GovernmentHospitalChoiceViewModel ViewModel) {
