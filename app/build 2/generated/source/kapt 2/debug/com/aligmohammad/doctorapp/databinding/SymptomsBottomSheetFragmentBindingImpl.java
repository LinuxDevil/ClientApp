...
public class SymptomsBottomSheetFragmentBindingImpl extends SymptomsBottomSheetFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.selectSymptomsTextView, 5);
        sViewsWithIds.put(R.id.symptomsSpinner, 6);
        sViewsWithIds.put(R.id.heatTempTextView, 7);
        sViewsWithIds.put(R.id.heatTempEditText, 8);
    }
    // views
    @NonNull
    ...
    public SymptomsBottomSheetFragmentBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }
    private SymptomsBottomSheetFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.listener == variableId) {
            ...
            setViewModel((com.aligmohammad.doctorapp.ui.dialogs.doctorconsulting.symptoms.SymptomsBottomSheetViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.aligmohammad.doctorapp.ui.dialogs.doctorconsulting.symptoms.SymptomsBottomSheetViewModel ViewModel) {
