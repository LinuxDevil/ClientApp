...
public class DateAndTimeBottomSheetFragmentBindingImpl extends DateAndTimeBottomSheetFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.dateEditText, 6);
        sViewsWithIds.put(R.id.timeTextView, 7);
        sViewsWithIds.put(R.id.timeEditText, 8);
    }
    // views
    @NonNull
    ...
    public DateAndTimeBottomSheetFragmentBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }
    private DateAndTimeBottomSheetFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.listener == variableId) {
            ...
            setViewModel((com.aligmohammad.doctorapp.ui.dialogs.datedialogfragment.DateAndTimeBottomSheetViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.aligmohammad.doctorapp.ui.dialogs.datedialogfragment.DateAndTimeBottomSheetViewModel ViewModel) {
