...
public class DoctorConsultingBottomSheetFragmentBindingImpl extends DoctorConsultingBottomSheetFragmentBinding  {
    ...
    public DoctorConsultingBottomSheetFragmentBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private DoctorConsultingBottomSheetFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.consultGeneralDoctor.setTag(null);
        this.mboundView0 = (android.widget.LinearLayout) bindings[0];
        this.mboundView0.setTag(null);
        this.requestADoctor.setTag(null);
        this.requestANurse.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.listener == variableId) {
            ...
            setViewModel((com.aligmohammad.doctorapp.ui.dialogs.doctorconsulting.DoctorConsultingBottomSheetViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.aligmohammad.doctorapp.ui.dialogs.doctorconsulting.DoctorConsultingBottomSheetViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x5L) != 0) {
            ...
            this.consultGeneralDoctor.setOnClickListener(listenerOnButtonClickedAndroidViewViewOnClickListener);
            this.requestADoctor.setOnClickListener(listenerOnButtonClickedAndroidViewViewOnClickListener);
            this.requestANurse.setOnClickListener(listenerOnButtonClickedAndroidViewViewOnClickListener);
        }
    }
