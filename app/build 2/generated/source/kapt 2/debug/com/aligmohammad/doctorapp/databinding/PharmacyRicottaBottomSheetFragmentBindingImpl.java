...
public class PharmacyRicottaBottomSheetFragmentBindingImpl extends PharmacyRicottaBottomSheetFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ricottaImageButton, 7);
        sViewsWithIds.put(R.id.confirm_button, 8);
    }
    // views
    @NonNull
    ...
    public PharmacyRicottaBottomSheetFragmentBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }
    private PharmacyRicottaBottomSheetFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.listener == variableId) {
            ...
            setViewModel((com.aligmohammad.doctorapp.ui.dialogs.pharmacyricottaorder.PharmacyRicottaBottomSheetViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.aligmohammad.doctorapp.ui.dialogs.pharmacyricottaorder.PharmacyRicottaBottomSheetViewModel ViewModel) {
