...
public class CityDistrictCompanyFragmentBindingImpl extends CityDistrictCompanyFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.confirm_button, 10);
    }
    // views
    @NonNull
    ...
    public CityDistrictCompanyFragmentBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }
    private CityDistrictCompanyFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.listener == variableId) {
            ...
            setViewModel((com.aligmohammad.doctorapp.ui.dialogs.citydistrictcompanydialog.CityDistrictCompanyViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.aligmohammad.doctorapp.ui.dialogs.citydistrictcompanydialog.CityDistrictCompanyViewModel ViewModel) {
