...
class DoctorPlaces : Fragment() {
    ...
    private lateinit var placeAdapter: DoctorPlaceRecyclerViewAdapter
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.doctor_places_fragment, container, false)
        setUpUI()
        return binding.root
    }
    ...
    private fun initRecycler() {
        placeAdapter =
            DoctorPlaceRecyclerViewAdapter(places, "Pharmacy")
    ...
    private fun setWatchers() {
        binding.searchBar.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                placeAdapter = DoctorPlaceRecyclerViewAdapter(filteredDoctors)
                placeAdapter.notifyDataSetChanged()
                binding.root.list.adapter = placeAdapter
        ...
        viewModel.doctorResponse.observe(viewLifecycleOwner, androidx.lifecycle.Observer {
            when (it) {
                is Resource.Loading -> {
